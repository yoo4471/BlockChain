...
def payments():
    ...
    if 'email' in session:
        ...
        print(db_user_search)
        # Here
        checkin = db_user_search[0][5]
        checkout = db_user_search[0][6]
        ...
        term = d1 - d0
        temp_charge = db_total_charge[0][0]
...
def payments_list():
    ...
    if request.method == 'POST':
        ...
        save_tran_info = [db_petsitter[save_int_count][1], petsitter_nickname[0][0], User, db_user_search[0][5], db_user_search[0][6], date, str(db_total_charge[0][0]), '\0']
