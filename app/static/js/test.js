function UET(o) {
    ...
    this.stringExists = function(n) {
        return n && n.length > 0
    }, this.domain = "bat.bing.com", this.secondaryDomain = "bat.r.msn.com", this.URLLENGTHLIMIT = 2048, this.pageLoadEvt = "pageLoad", this.customEvt = "custom", o.Ver = o.Ver !== undefined && (o.Ver === "1" || o.Ver === 1) ? 1 : 2, this.supportsCORS = this.supportsXDR = !1, this.validKeyNames = {
        ec: 1,
        el: 1,
        ev: 1,
        ea: 1
        ...
        gv: 1,
        gc: 1
    }, this.invalidKeyException = "Invalid data: Key Name: ", this.invalidEventException = "Invalid event type: Event Type: ", this.evq = o.q || [], delete o.q, this.evqDispatch = !1, this.pageLoadDispatch = !1, this.documentLoaded = !!document.body, this.eventPushQueue = [], n = this, this.checkuetHostdocumentload = function() {
    ...
    }, i = window.location.protocol, t = 0, o.Ver === 1 && o.advertiserId !== undefined && (t = o.advertiserId), this.postURL = i + "//" + this.domain + "/action/" + t, this.urlPrefix = this.postURL + "?", this.secondPostURL = i + "//" + this.secondaryDomain + "/action-uic/" + t, this.secondUrlPrefix = this.secondPostURL + "?", delete o.advertiserId, delete o.adv, o.Ver !== 1 && (this.stringExists(o.tagId) && !this.stringExists(o.ti) && (o.ti = o.tagId), delete o.tagId, delete o.Sig), this.invisibleDiv = null, this.invisibleFrame = null, this.getGuid = function() {
        function n() {
        ...
        var t = this.createInvisibleElement(this.invisibleDiv, "img"),
            i, r;
        return t.width = 0, t.height = 0, i = Math.floor(Math.random() * 1e6), r = n + "&rn=" + i, o.alt && t.setAttribute("alt", o.alt), t.setAttribute("src", r), i
        ...
        var u, t, f, i;
        n = this.addLoadTime(n), n = this.addFraudSignals(n), u = "", t = window.document.referrer, this.stringExists(t) && (n.r = encodeURIComponent(t), u = t.split("?")[0]), f = window.document.title, this.stringExists(f) && (n.tl = f), window.document.head.getElementsByTagName("meta").keywords && (i = window.document.head.getElementsByTagName("meta").keywords.content, this.stringExists(i) && (n.kw = i));
        if (window.self != window.top) n.hasOwnProperty("r") && (n.p = n.r, n.r = "");
        else {
            var r = window.location.href,
                e = window.location.hash,
                o = r.indexOf(e) >= 0 ? r : r + e;
            n.p = encodeURIComponent(o), n.r = encodeURIComponent(u)
        }
        return n
        ...
        return t.toString().indexOf(",") !== -1 && (u = t.replace(/,/g, "")), r = parseFloat(u), (isNaN(u) || isNaN(r) || f && r.toString().indexOf(".") !== -1) && this.throwError(n + " should be " + (f ? "an integer" : "a number")), r > 9999999 ? this.throwError(n + " cannot be greater than 9999999") : r < 0 ? this.throwError(n + " cannot be less than 0") : this.getDecimalPlaces(r) > i && this.throwError(n + " cannot have more than " + i + " decimal places"), r
        ...
        this.invisibleDiv || this.createInvisibleDiv(document.body), t.evt = n, window.self != window.top && (t.ifm = 1), n === this.pageLoadEvt && (t = this.addPageData(t), this.fireBeacon(t, !0), this.pageLoadDispatch = !0), this.fireBeacon(t), t.abf = !0, n === this.pageLoadEvt && this.evqDispatch === !1 && this.dispatchq()
    ...
    }, this.fireBeacon = function(n, t) {
        var f = this.urlPrefix,
            e = this.postURL;
        t && (f = this.secondUrlPrefix, e = this.secondPostURL);
        var i = this.combine(o, n),
            r = this.stringifyToRequest(i),
            u = this.removeTrailingAmp(f + r);
        encodeURI(u).length > this.URLLENGTHLIMIT && (delete i.kw, r = this.stringifyToRequest(i), u = this.removeTrailingAmp(f + r)), encodeURI(u).length > this.URLLENGTHLIMIT && (delete i.p, r = this.stringifyToRequest(i), u = this.removeTrailingAmp(f + r)), this.fireBeaconImg(u)
    }
}
...
/*1489117090,,JIT Construction: v2882316,ko_KR*/
...
try {
                        ...
                        z = {
                            ...
                            _createMobileLoader: function aa() {
                                ...
                                if (p.nativeApp()) {
                                    ...
                                    ba = '<div class="overlayLoader">' + '<div id="fb_dialog_loader_spinner"></div>' + '<a id="fb_dialog_loader_close" href="#">' + q._("\ucde8\uc18c") + '</a>' + '</div>';
                                } else ba = '<div class="dialog_header">' + '<table>' + '  <tbody>' + '    <tr>' + '      <td class="header_left">' + '        <label class="touchable_button">' + '          <input type="submit" value="' + q._("\ucde8\uc18c") + '"' + '            id="fb_dialog_loader_close"/>' + '        </label>' + '      </td>' + '      <td class="header_center">' + '        <div>' + '         ' + q._("\uc77d\uc5b4\ub4e4\uc774\ub294 \uc911...") + '        </div>' + '      </td>' + '      <td class="header_right">' + '      </td>' + '    </tr>' + '  </tbody>' + '</table>' + '</div>';
                                return z.create({
                ...
                __d('sdk.MBasicInitializer', ['sdk.DOM', 'sdk.Runtime', 'sdk.UA', 'sdk.URI', 'UrlMap', 'sdk.fbt', 'sdk.feature'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    var o = function q() {
                        function r(s) {
                            ...
                            w.textContent = m._("Facebook\uc5d0 \uacf5\uc720");
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"2882316","namespace":"FB","message":"' + e.message + '"}}');
}
